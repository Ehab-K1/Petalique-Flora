...
export const TRADE_ITEMS: TradeItem[] = [
  { id: 'garden-rose', name: 'Garden Roses', latin: 'Rosa', unit: 'stem', pricePerUnit: 2.4, moq: 25, stock: 'in' },
  { id: 'babys-breath', name: 'Baby’s Breath', latin: 'Gypsophila', unit: 'bunch', pricePerUnit: 6.5, moq: 10, stock: 'in' },
  { id: 'ranunculus', name: 'Ranunculus', latin: 'Ranunculus', unit: 'stem', pricePerUnit: 3.1, moq: 25, stock: 'low' },
  { id: 'eucalyptus', name: 'Eucalyptus', latin: 'Eucalyptus cinerea', unit: 'bunch', pricePerUnit: 7.2, moq: 10, stock: 'in' },
  { id: 'hydrangea', name: 'Hydrangea', latin: 'Hydrangea macrophylla', unit: 'stem', pricePerUnit: 4.5, moq: 20, stock: 'in' },
  { id: 'tulip', name: 'Tulips', latin: 'Tulipa', unit: 'stem', pricePerUnit: 1.9, moq: 50, stock: 'in' },
  { id: 'lisianthus', name: 'Lisianthus', latin: 'Eustoma', unit: 'stem', pricePerUnit: 2.8, moq: 25, stock: 'low' },
  { id: 'peony', name: 'Peonies', latin: 'Paeonia', unit: 'stem', pricePerUnit: 6.5, moq: 20, stock: 'pre', seasonal: true },
];
