  ...
  return (
    <section className="section-sm bg-bone">
      <div className="container" style={{ maxWidth: 760 }}>
        ...
        <h1 className="h1 serif-em" style={{ marginTop: 8 }}>Terms of service</h1>
        ...
        <div className="legal-body">
          ...
          <p className="body">
            ...
            value and aesthetic — and tell you what changed.
          </p>

          <h2 className="h3" style={{ marginTop: 'var(--s-6)' }}>Re-bloom guarantee</h2>
          <p className="body">
            If a bouquet arrives less than perfect — wilted, damaged, mis-coloured — we remake it,
            no questions, and put it on the doorstep within 24 hours. Photograph what you receive
            and reply to your confirmation email.
          </p>
